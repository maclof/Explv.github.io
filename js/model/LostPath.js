...
import { getPath } from '../lost_walker/lost_walker.js';

export class LostPath {
        ...
        if (this.positions.length > 0) {
            ...
            getPath({
                ...
                onSuccess: function (path) {
                    let spacingStr = $("#lost-spacing").val();
                ...
                onError: function (start, end, errorMsg) {
                    Swal({
                        position: 'top',
                        type: 'error',
                        title: `Failed to get path between ${start} and ${end} from Lost.\nReason: '${errorMsg}'`,
