...
import { getPath } from '../eternal_walker/eternal_walker.js';

export class EternalPath {
        ...
        if (this.positions.length > 0) {
            ...
            getPath({
                ...
                onSuccess: function (path) {
                    let spacingStr = $("#eternal-spacing").val();
                ...
                onError: function (start, end, errorMsg) {
                    Swal({
                        position: 'top',
                        type: 'error',
                        title: `Failed to get path between ${start} and ${end} from Eternal Client.\nReason: '${errorMsg}'`,
